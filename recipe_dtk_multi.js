...
//    <img class='rcp-image' src='images/20190516_162549_squid stuffed w chicken and spinach.jpg'>
...
//  IGDT_TYPE: UNCHECKED / DERIVED / ATOMIC / OTS / DTK  - SEE TOP
let IGD_IDX_TYPE = 0;
let IGD_IDX_QTY  = 1;
let IGD_IDX_EACH = 2;
let IGD_IDX_NAME = 3;
...
function expandIngredientToRecipeCard(event) {
  ...
  if (recipeCard === null) {
    ...
    recipeObj = recipeObjectFromName(subcomponentName);
